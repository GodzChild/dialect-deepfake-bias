...
Mitigation v2 --- a \emph{controlled adaptation} consisting of
...
Chapter~\ref{chap:detector-verification} (Chapter~\ref{chap:mitigation}, Sections~\ref{sec:mitigation-decte-result}--\ref{sec:mitigation-indomain-sanity}). Chapter~\ref{chap:subgroup-diagnostics} added a
