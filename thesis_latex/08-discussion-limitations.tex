...
weaker classifier and its EER on both corpora was $\sim$10\,pp higher
than the AASIST equivalents --- but they agreed on the sign of the
gap and, remarkably, on its rough magnitude: $\sim$12\,pp on both
...
that \emph{error concentration and mitigation benefit were not uniform
...
Chapter~\ref{chap:conclusion} sketches the follow-up studies that would extend the
